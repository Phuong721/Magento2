...
use KhieuDV\Blog\Model\ResourceModel\Faq\CollectionFactory;
...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        Context $context,
        \KhieuDV\Blog\Logger\Logger $logger,
        Filter $filter,
...
//        $this->messageManager->addSuccess(__('A total of %1 record(s) have been modified.', $collection->getSize()));
    ...
    {
        return $this->_authorization->isAllowed('KhieuDV_Blog::row_data_status');
    }
}
