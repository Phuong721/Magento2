<?php
namespace KhieuDV\Blog\Controller\Adminhtml\Faq;

use Magento\Framework\App\Filesystem\DirectoryList;
use Magento\Framework\Filesystem;
use Magento\Framework\Filesystem\Directory\Read;
use Magento\MediaStorage\Model\File\Uploader;
use KhieuDV\Blog\Logger\Logger;
use KhieuDV\Blog\Model\FAQFactory;
use KhieuDV\Blog\Model\FAQStoreFactory;
...
//                $this->log->info('faq data: ' . json_encode($faqData->getData()));
                $collection = $this->_objectManager->create('\KhieuDV\Blog\Model\ResourceModel\FaqStore\Collection');
...
//                $this->log->info('filter data: ' . json_encode($data));
            ...
            // event
            $this->_eventManager->dispatch('khieudv_blog_modified_db', ['title'=>$obs_title, 'id'=>$faq_id]);
    ...
    {
        return $this->_authorization->isAllowed('KhieuDV_FAQ::save');
    }
}
