...
class Index extends \Magento\Framework\View\Element\Template
{
    ...
    public function _prepareLayout()
    {
        $this->pageConfig->getTitle()->set(
            $this->_scopeConfig->getValue(
                'khieudv/blog_general/general/display_title',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            )
        );
        $faqPerTab = (int) $this->_scopeConfig->getValue(
            'khieudv/blog_general/general/display_number_faq',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    {
        $faqPerTab = (int) $this->_scopeConfig->getValue('khieudv/blog_general/general/display_number_faq', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
